...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.2.4'));
 ...
 */
new project_tsconfig_paths.Version('20.2.4');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.2.4` usually means that core is at head so it supports
